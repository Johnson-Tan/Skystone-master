...
public class ActualPipeline extends OpenCvPipeline {
    ...
    public ActualPipeline(Telemetry tl) {
        this.tl = tl;
        defaultValues = true;
        blocks = null;
    }
    public ActualPipeline() {
        this(null);
    }

    public ActualPipeline(double firstSkystonePositionPercentage, double percentSpacing, double stoneWidth, double stoneHeight, Telemetry tl){
        defaultValues = false;
    ...
    public ActualPipeline(double firstSkystonePositionPercentage, double percentSpacing, double stoneWidth, double stoneHeight){
    ...
    public Mat processFrame(Mat input) {
        setValues(input.width(), input.height()*1.5);
        try {
            /**
